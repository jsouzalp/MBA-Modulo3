...
public class HistoricoAprendizadoTests
{
    ...
    [Theory]
    [InlineData(_cursoIdInvalido, _aulaIdValido, _nomeAulaValido, "*curso não pode ser vazio*")]
    [InlineData(_cursoIdValido, _aulaIdInvalido, _nomeAulaValido, "*aula não pode ser vazio*")]
    [InlineData(_cursoIdValido, _aulaIdValido, "", "*Nome da aula não pode ser vazio*")]
    [InlineData(_cursoIdValido, _aulaIdValido, "abc", "*Nome da aula deve ter entre 5 e 100 caracteres*")]
    public void Nao_deve_criar_historico_com_dados_invalidos(string cursoIdStr, string aulaIdStr, string nomeAula, string mensagemErro)
    {
        // Arrange
        ...
        // Act
        Action act = () => new HistoricoAprendizado(cursoId, aulaId, nomeAula);
