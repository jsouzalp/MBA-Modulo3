...
namespace Plataforma.Educacao.Conteudo.Domain.Tests
{
    public class AulaTests
    {
        ...
        public void Deve_alterar_descricao_valida()
        {
            ...
            var conteudo = CriarInstanciaAula();

            // Act
            conteudo.AlterarDescricao(novadescricao);

            // Assert
            conteudo.Descricao.Should().Be(novadescricao);
        }
        ...
        public void Deve_alterar_carga_horaria_valida()
        {
            ...
            // Act
            conteudo.AlterarCargaHoraria(novaCargaHoraria);

            // Assert
            conteudo.CargaHoraria.Should().Be(novaCargaHoraria);
        }
        ...
        public void Deve_alterar_ordem_valida()
        {
            ...
            // Act
            conteudo.AlterarOrdemAula(novaOrdem);

            // Assert
            conteudo.OrdemAula.Should().Be(novaOrdem);
        }
        #endregion
    }
}
